          ...
          {testimonials.map((t, idx) => (
            <BlurReveal key={idx} delay={0.1 * idx}>
              <div className="relative overflow-hidden rounded-2xl p-[1px] h-full flex hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 group">
                ...
                <div className="relative bg-white/[0.03] backdrop-blur-md p-6 sm:p-8 rounded-2xl flex flex-col justify-between w-full h-full cursor-default z-10 border border-white/10">
                  <div>
                ...
                <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-xs font-bold text-[#a5b89f] uppercase tracking-wider">{t.metrics}</p>
                  </div>
                </div>
               </div>
              </div>
